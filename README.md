...
This is a small word mixer, that I coded in an afternoon. Check out the [explaination video]()
...
## Structure
This webapp consists of a locally restful flask API, that exposes an endpoint to mix the two words, and a nuxt frontend. The user will has two text inputs to enter the words and a slider, to adjust the mixture.
